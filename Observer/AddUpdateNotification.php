...
{
    private const PACKAGE     = 'etechflow/module-options-plugin';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-options-plugin.json';
    private const CACHE_KEY   = 'etechflow_options_update_check';
    private const CACHE_TTL   = 21600;
    private const MODULE_NAME = 'Etechflow_OptionsPlugin';
    ...
    public function execute(Observer $observer): void
    {
        try {
            ...
            $title = (string) __('eTechFlow Extra Options %1 is available', $latest['version']);
